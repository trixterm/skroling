...
import HeroFloatingLetters from "@/components/animations/HeroFloatingLetters";
...
const HeroWorkSection = () => {
  ...
  return (
    <>
          ...
          <div className="relative z-10 grid h-full w-full grid-cols-4 grid-rows-7 md:p-4 lg:grid-cols-12 lg:grid-rows-6 lg:gap-0 lg:p-0">
            ...
            <div className="work-letters-wrapper contents">
              ...
              <div className="work-letter-w flex h-24 w-full items-center justify-center text-xs font-medium uppercase tracking-wide text-gray-700 lg:h-full col-start-1 row-start-2 lg:col-start-4 lg:row-start-3">
                ...
                >
                  <path
                    d="M162.233 471.25L-3.17334e-06 10.301H74.6788L166.74 297.428L274.252 0.000475814H275.539L383.695 297.428L475.756 10.301H550.435L388.201 471.25H386.914L274.895 170.603L163.521 471.25H162.233Z"
                    fill="black"
                  />
                </svg>
              </div>
              ...
              <div className="work-letter-k flex h-24 w-full items-center justify-center text-xs font-medium uppercase tracking-wide text-gray-700 col-start-3 row-start-5 lg:h-full lg:col-start-9 lg:row-start-3">
                ...
                >
                  <path
                    d="M3.38014e-05 401.719V0.000582987H62.5533V185.939L236.44 0.000582987H319.653L129.124 199.712L325.392 401.719H241.605L62.5533 214.059V401.719H3.38014e-05Z"
                    fill="black"
                  />
                </svg>
              </div>
      ...
      {/* Animacijos controller’is – sėdi šalia hero sekcijos, bet viską valdys per selektorių */}
      <HeroFloatingLetters
        maxTranslate={20}
        ease={0.20}
        fpsCap={60}
